...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css"
    ...
    <form action="{{ route('customer.update', $customer->id) }}" enctype="multipart/form-data" method="post"
        ...
        <input type="text" id="contact_phone" name="contact_phone" class="form-control" value="{{$customer->contact_phone}}">
        ...
        <input type="text" id="contact_email" name="contact_email" class="form-control" value="{{$customer->contact_email}}">
